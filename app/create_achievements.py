...
create("Knowledge", "Achievements have sounds now?", "An infamous song in osu! history, and a great map. But what you hear may not be what you think. Submit a score on the mapset of these hit sounds.", tags=["audio"], audio="theFunny.wav")
...
create("Skill", "Reading Mashup", "Compete for the highest score on this map. This can only be completed on lazer. Must use no mods or NF.", tags=["mode-o", "competition", "score"], beatmap_id=4820929)

# Day 8 (100)
create("Secret", "Decoder", "V2hvIGlzIHRoaXMgUm94a3l1dWJpIGd1eT8gTWF5YmUgaGlzIG1hcCBzb3VuZHMgZ29vZCB3aXRoIE5DLg==", tags=[])
...
create("Knowledge", "Beats from the top", "From #1 to musician. Submit a score on this Featured Artist's first song that got ranked. ", tags=[])
...
create("Knowledge", "Promise", "A well-known artist in both the osu! and vtuber communities. Submit a score on a mapset of one of their songs under their older alias using EZNCHD.", tags=[])
