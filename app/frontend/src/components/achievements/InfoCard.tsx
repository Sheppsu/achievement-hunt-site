...
export default function InfoCard() {
  return (
    <div className="card">
      <h1 className="card--teams__title">Capture The Achievement</h1>
      <p className="info-text">
        Starts November 16th - Ends November 25th (0:00 UTC)
      </p>
      <p className="card--teams__subtitle">About</p>
      <p className="info-text">
      ...
      <p className="card--teams__subtitle">Teams</p>
      <p className="info-text">
      ...
      <p className="card--teams__subtitle">Achievements</p>
      <p className="info-text">
      ...
      <p className="card--teams__subtitle">Scoring</p>
      <p className="info-text">
      ...
      <p className="card--teams__subtitle">Profile stalking</p>
      <p className="info-text">
